...
const ServersNewUser = () => {
  ...
  const serverTypes = [
    ...
    {
      icon: <ServerIcon className="h-10 w-10 text-green-500" />,
      name: "Rest API Servers",
      description: "RESTful API servers for traditional HTTP communication"
    },
    {
      icon: <Bot className="h-10 w-10 text-amber-500" />,
      name: "Socket Servers",
      description: "WebSocket servers for bidirectional real-time communication"
    }
  ];
  ...
  return (
    <div className="container max-w-5xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-2xl font-semibold mb-4">Supported server types</h2>
