...
import { Laptop, Server, Search, ArrowRight, RefreshCw, Globe, TerminalSquare, Zap, HelpCircle } from "lucide-react";
...
const HostsNewUser = () => {
  ...
  return <div className="container py-8 max-w-5xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="text-center space-y-3 max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground text-lg font-normal">Hosts are applications that support MCP and run server profile. </p>
      </div>
