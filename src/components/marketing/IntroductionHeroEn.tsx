      ...
      <div className="container px-4 md:px-6">
        ...
        duration: 0.7
          ...
          <div className="space-y-5">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight font-roboto leading-tight text-blue-600">
              Your AI Universe - Explore, Control, Create
            </h1>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-gray-900 dark:text-white font-roboto">
