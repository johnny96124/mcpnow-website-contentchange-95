...
const CompatibilitySection = () => {
  ...
  return <section id="compatibility" className="py-20 bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-950">
      <div className="container px-4 md:px-6">
        ...
        <motion.div className="max-w-5xl mx-auto relative" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
          ...
          <div className="relative w-full overflow-hidden">
            ...
            <div className="w-full overflow-x-auto py-8 scrollbar-none">
              <div className="inline-flex gap-10 animate-scroll">
                {[...hosts, ...hosts].map((host, idx) => <motion.div key={idx} className="flex flex-col items-center mx-2" initial={{
                opacity: 0,
                y: 10
              }} animate={{
                opacity: 1,
